...
def data_over_time(df, col):
    data_over_time = (
        df.drop_duplicates(['Year', col])   # unique Year-col combinations
          .groupby('Year')
          .count()[col]
          .reset_index()
...
def most_successful(df, sport):
    ...
    x = temp_df['Name'].value_counts().reset_index().head(15).merge(df, on='Name', how='left')[['Name', 'count', 'Sport', 'NOC']].drop_duplicates('Name').reset_index(drop=True)
